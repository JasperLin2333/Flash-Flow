...
import { History, Zap, X, ChevronDown, ArrowUpRight, Home as HomeIcon } from "lucide-react";
 ...
 * 6. 底部账号管理
 */
export default function AppSidebar({ currentFlowId }: { currentFlowId?: string }) {
                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="pt-3 pb-2 px-4">
                        <div className="mt-2 space-y-2">
                            <Button
                                onClick={() => router.push("/")}
                                className="w-full h-9 rounded-lg bg-white border border-gray-200 text-gray-900 hover:bg-gray-50 shadow-sm font-medium transition-all duration-150 gap-2 justify-start px-3"
                            >
