 ...
 * 6. 底部账号管理
 */
export default function AppSidebar({ currentFlowId, onRefreshTrigger, onNewConversation }: { currentFlowId?: string; onRefreshTrigger?: number; onNewConversation?: () => void }) {
    ...
    return (
        <Sheet>
            <SheetTrigger asChild>
                <Button
                    className="absolute top-20 left-8 rounded-full bg-black text-white hover:bg-black/90 active:bg-black/95 shadow-md font-semibold transition-all duration-150 h-10 px-3 flex items-center gap-2"
                    aria-label="历史记录"
                    title="历史记录"
                >
            ...
            <Button
                ...
                className="absolute top-20 left-44 rounded-full bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 active:bg-gray-100 shadow-sm transition-all duration-150 h-10 w-10 flex items-center justify-center"
                aria-label="新建对话"
                title="新建对话"
            >
