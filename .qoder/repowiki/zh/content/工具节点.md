...
**Section sources**
- [tool节点详情.md](file://docs/design/tool节点详情.md#L9-L15)
...
**Section sources**
- [tool节点详情.md](file://docs/design/tool节点详情.md#L18-L121)
...
**Diagram sources**
- [tool节点详情.md](file://docs/design/tool节点详情.md#L127-L147)
...
**Section sources**
- [ToolNodeExecutor.ts](file://src/store/executors/ToolNodeExecutor.ts#L1-L159)
- [tool节点详情.md](file://docs/design/tool节点详情.md#L152-L191)
...
| 文件 | 职责 |
|------|------|
| [ToolNodeExecutor.ts](file://src/store/executors/ToolNodeExecutor.ts) | Tool 节点执行器，负责变量收集、替换和执行编排 |
| [registry.ts](file://src/lib/tools/registry.ts) | 工具注册中心，管理所有工具的 Schema 和元数据 |
| [index.ts](file://src/app/actions/tools/index.ts) | 工具执行入口，路由到具体工具执行器 |
| [executors/*](file://src/app/actions/tools/executors) | 具体工具执行器实现（webSearch、calculator、datetime 等） |
| [ToolDebugDialog.tsx](file://src/components/flow/ToolDebugDialog.tsx) | 调试对话框，动态渲染工具输入表单 |
| [ToolNodeForm.tsx](file://src/components/builder/node-forms/ToolNodeForm.tsx) | 节点配置表单 |
...
**Diagram sources**
- [tool节点详情.md](file://docs/design/tool节点详情.md#L208-L222)
...
**Section sources**
- [registry.ts](file://src/lib/tools/registry.ts#L1-L256)
- [index.ts](file://src/app/actions/tools/index.ts#L1-L88)
- [tool节点详情.md](file://docs/design/tool节点详情.md#L224-L268)
...
**Section sources**
- [ToolNodeExecutor.ts](file://src/store/executors/ToolNodeExecutor.ts#L38-L121)
- [promptParser.ts](file://src/lib/promptParser.ts#L50-L66)
- [tool节点详情.md](file://docs/design/tool节点详情.md#L270-L307)
...
**Section sources**
- [ToolNodeExecutor.ts](file://src/store/executors/ToolNodeExecutor.ts#L137-L149)
- [index.ts](file://src/app/actions/tools/index.ts#L79-L87)
- [tool节点详情.md](file://docs/design/tool节点详情.md#L308-L343)
...
**Section sources**
- [ToolNodeExecutor.ts](file://src/store/executors/ToolNodeExecutor.ts#L31-L32)
- [tool节点详情.md](file://docs/design/tool节点详情.md#L344-L378)
...
**Section sources**
- [registry.ts](file://src/lib/tools/registry.ts#L234-L255)
- [index.ts](file://src/app/actions/tools/index.ts#L42-L78)
- [tool节点详情.md](file://docs/design/tool节点详情.md#L379-L475)