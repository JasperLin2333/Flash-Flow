...
**节段来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L3-L17)
...
**节段来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L18-L70)
- [BranchNodeExecutor.ts](file://src/store/executors/BranchNodeExecutor.ts#L1-L254)
- [executionActions.ts](file://src/store/actions/executionActions.ts#L1-L375)
...
**节段来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L71-L125)
- [BranchNodeExecutor.ts](file://src/store/executors/BranchNodeExecutor.ts#L5-L14)
...
**节段来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L126-L141)
...
**节段来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L143-L197)
...
| 文件 | 职责 |
|------|------|
| [BranchNodeExecutor.ts](file://src/store/executors/BranchNodeExecutor.ts) | Branch 节点执行器实现 |
| [executionActions.ts](file://src/store/actions/executionActions.ts) | 流程执行引擎与分支控制 |
| [contextUtils.ts](file://src/store/executors/contextUtils.ts) | 上下文数据访问工具 |
| [flow.ts](file://src/types/flow.ts) | BranchNodeData 类型定义 |
...
**图示来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L211-L219)
...
**图示来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L223-L241)
...
**节段来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L243-L263)
...
**节段来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L264-L349)
...
**节段来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L350-L482)
...
**节段来源**  
- [branch节点详情.md](file://docs/design/branch节点详情.md#L482-L513)