...
| **⚡ 快速/高性价比** | \`"qwen-flash"\` <br> \`"gemini-3-flash-preview"\` <br> \`"doubao-seed-1-6-flash-250828"\` <br> \`"mimo-v2-flash"\` | 简单问答、翻译、分类、小红书文案 |
| **⚖️ 均衡/通用** | \`"doubao-1-5-pro-32k-character-250715"\` <br> \`"doubao-seed-1-6-251015"\` <br> \`"THUDM/GLM-Z1-9B-0414"\` | 常规对话、文本生成 |
| **🧪 实验/其他** | \`"deepseek-ai/DeepSeek-R1-0528-Qwen3-8B"\` | 需要尝试新模型特性的不管是啥 |
| **🌐 多模态/视觉** | \`"zai-org/GLM-4.6V"\` | 涉及图片理解的任务 |

> ⚠️ **注意**: 除非用户明确指定，否则默认优先使用 \`deepseek-chat\` (性能最均衡) 或 \`qwen-flash\` (速度最快)。
